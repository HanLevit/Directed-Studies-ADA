...
macro_trial1_graph = ggplot(macro_trial1_data, aes(x = Treatment, y = Settlement, fill = Treatment)) + 
...
histDist(macro_trial1_data$Settlement, "BCPEo")
```
...
macro_trial2_graph = ggplot(macro_trial2_data, aes(x = Treatment, y = Settlement, fill = Treatment)) + 
  ...
  scale_fill_manual(values = my_cols1) + 
  theme_classic() +
  labs(x = "Trial A", y = "Settlement (spores/ml)") +
...
macro_trial3_graph = ggplot(macro_trial3_data, aes(x = Treatment, y = Settlement, fill = Treatment)) + 
  ...
  scale_fill_manual(values = my_cols1) + 
  theme_classic() +
  labs(x = "Trial B", y = "Settlement (spores/ml)") +
  theme(axis.title = element_text(size = 10)) +
  theme(legend.position = "none") 
...
macro_trial4_graph = ggplot(macro_trial4_data, aes(x = Treatment, y = Settlement, fill = Treatment)) + 
  ...
  scale_fill_manual(values = my_cols1) + 
  theme_classic() +
  labs(x = "Trial C", y = "Settlement (spores/ml)") +
  theme(axis.title = element_text(size = 10)) +
  theme(legend.position = "none") 


my_cols6 = c("20kHz" = "orange2", "Control" = "blue3")
...
combined_graph = ggplot(macro_trial2_3_4_data, aes(x = Treatment, y = Settlement, fill = Treatment)) + 
  ...
  theme_classic() +
  labs(x = "Combined data (trial 2, 3, 4)", y = "Settlement (spores/ml)") +
  theme(axis.title = element_text(size = 10)) +
  theme(legend.position = "none") 
...
```{r}
library(patchwork)
spore_settlement = (macro_trial2_graph | macro_trial3_graph | macro_trial4_graph) / (combined_graph)
spore_settlement+ plot_annotation(tag_levels = 'A')
