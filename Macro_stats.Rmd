...
macro_trial1.mod <- gamlss(logSettlement ~ Treatment, data = transformed_trial_M1, family = "SEP2")
...
leveneTest(logSettlement ~ Treatment, data = transformed_trial_M1)
# not equal variances
...
# plotting differences in settlement for treatment vs control
...
macro_combined.mod <- gamlss(Settlement ~ Treatment, data = macro_trial_all_data, family = "SEP2")
...
# loading all data needed for graphs so I can run this without going back through
# the whole code
macro_trial2_data = read.csv("data/macro_trial2_data.csv")
macro_trial3_4_data = read.csv("data/macro_trial3_4_data.csv")
macro_trial_all_data = read.csv("data/macro_trial2+3+4_combined.csv")
...
```{r}
# running a gamlss model including time
